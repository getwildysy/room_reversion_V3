...
const ScheduleCalendar: React.FC<ScheduleCalendarProps> = ({
  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md md:h-full flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 border-b pb-4">
        ...
        <div className="flex items-center justify-between sm:justify-end space-x-2 mt-4 sm:mt-0">
          ...
          <button
            ...
            className="px-3 py-1 text-sm bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition font-semibold"
          >
            回到本週
          </button>
